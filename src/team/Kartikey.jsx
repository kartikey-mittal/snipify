...
console.log(imageUrl);
   ...
   // const [loading, setLoading] = useState(true);
    ...
    const images = ['https://m.media-amazon.com/images/I/51VRzH-kQ+L.jpg', 'https://m.media-amazon.com/images/I/51VRzH-kQ+L.jpg', 'https://m.media-amazon.com/images/I/51VRzH-kQ+L.jpg'];
                ...
                <div style={contentStyle}>
                    ...
                    <div style={mainboxStyle}>
                     ...
                     <div
                                ...
                                <div style={{ display: "flex", justifyContent: "space-around", flexDirection: isMobileView ? 'column' : 'row',marginTop: 50 ,alignItems: isMobileView ? 'center' : 'center',
}}>
                                    
                            {images.map((imageUrl, index) => (
                                <img key={index} src={imageUrl} alt={`uploaded-${index}`} style={{ width: 120, height: 'auto',  borderRadius: 10 ,resizeMode:"cover",paddingTop:isMobileView ? 20 : 0}} />
                            ))}
                        </div>
